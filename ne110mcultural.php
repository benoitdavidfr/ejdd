...
class NE110mCultural extends NaturalEarth {
  ...
  const YAML_FILE = 'ne110mcultural.yaml';
...
class NE110mCulturalBuild {
  ...
  static function buildGeoJson(): void {
    NaturalEarthBuild::buildGeoJson(self::SHP_DIR, NE110mCultural::GEOJSON_DIR, NE110mCultural::COORDINATE_PRECISION);
  }
  
  static function main(): void {
    switch ($_GET['action'] ?? null) {
      case null: {
        echo "COORDINATE_PRECISION=",NE110mCultural::COORDINATE_PRECISION,"\n";
        printf(" soit au 1:50m: %.3f mm<br>\n",
              100_000 // taille 1° en mètres
            * 10**-NE110mCultural::COORDINATE_PRECISION // la résolution en degrés
            * NE110mCultural::MAP_SCALE // l'échalle de la carte
